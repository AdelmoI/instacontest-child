...
<section id="profile" class="mt-16 px-4 py-6 bg-white">
    <div class="flex items-center gap-4">
        <?php if ( is_user_logged_in() ) : ?>
            ...
            <!-- ↓ 1. tolto p-1  ↓ 2. aggiunto block all’img -->
            <div class="avatar-gradient rounded-full">
                <?php echo get_avatar(
                    $current_user->ID,
                    64,
                    '',
                    '',
                    [ 'class' => 'w-16 h-16 rounded-full border-2 border-white block' ]
                ); ?>
            </div>

            <div>
                <h2 class="text-black font-bold text-lg">
                    CIAO <?php echo strtoupper( $current_user->display_name ); ?>
                </h2>
        ...
        <?php else : ?>
            ...
            <!-- ↓ stessa correzione nel ramo “ospite” -->
            <div class="avatar-gradient rounded-full">
                <div class="w-16 h-16 rounded-full border-2 border-white bg-gray-300
            ...
            <div>
                ...
                <p class="text-gray-400 text-sm">
                    <a href="<?php echo wp_login_url(); ?>" class="text-blue-500">Accedi</a> per partecipare!
                </p>
            </div>
