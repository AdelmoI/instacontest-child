...
<body class="bg-gray-50">
    ...
    <header id="header" class="fixed top-0 w-full bg-white border-b border-gray-200 z-50">
        <div class="flex items-center justify-between px-4 py-3">
            ...
            <div></div>
            <a href="/register" class="text-black text-sm font-medium">
                Registrati
            </a>
        </div>
    </header>
    ...
    <section class="mt-16 px-4 py-6 bg-gray-50 min-h-screen">
        <div class="max-w-md mx-auto">
            ...
            <div class="text-center mb-6">
                ...
                <h1 class="text-black font-bold text-2xl mb-2">Benvenuto su InstaContest</h1>
                <p class="text-gray-500 text-lg">Accedi al tuo account</p>
            </div>
